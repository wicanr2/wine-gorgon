...
var Table = map[string]Func{
	...
	"KERNEL.#23":  {"KERNEL", 23, "LOCKSEGMENT", 2},
	"KERNEL.#74":  {"KERNEL", 74, "OPENFILE", 10},
	"KERNEL.#102": {"KERNEL", 102, "DOS3CALL", 0},
	"KERNEL.#136": {"KERNEL", 136, "GETDRIVETYPE", 2},
	"KERNEL.#137": {"KERNEL", 137, "FATALAPPEXIT", 6},
	// --- USER：PTO2 於 2026-09-11 補（10 支）---
	"USER.#28":  {"USER", 28, "CLIENTTOSCREEN", 6},
	"USER.#87":  {"USER", 87, "DIALOGBOX", 12},
	"USER.#88":  {"USER", 88, "ENDDIALOG", 4},
	"USER.#110": {"USER", 110, "POSTMESSAGE", 10},
	"USER.#224": {"USER", 224, "GETWINDOWTASK", 2},
	"USER.#232": {"USER", 232, "SETWINDOWPOS", 14},
	"USER.#291": {"USER", 291, "SETWINDOWSHOOKEX", 10},
	"USER.#292": {"USER", 292, "UNHOOKWINDOWSHOOKEX", 4},
	"USER.#293": {"USER", 293, "CALLNEXTHOOKEX", 12},
	"USER.#421": {"USER", 421, "WVSPRINTF", 12},
	// --- GDI：PTO2 於 2026-09-11 補（5 支）---
	"GDI.#3":   {"GDI", 3, "SETMAPMODE", 4},
	"GDI.#29":  {"GDI", 29, "PATBLT", 14},
	"GDI.#92":  {"GDI", 92, "GETTEXTFACE", 8},
	"GDI.#363": {"GDI", 363, "GETPALETTEENTRIES", 10},
	"GDI.#441": {"GDI", 441, "GETDIBITS", 18},
	// --- WING：PTO2 於 2026-09-11 補（6 支）---
	"WING.#1001": {"WING", 1001, "WINGCREATEDC", 0},
	"WING.#1002": {"WING", 1002, "WINGRECOMMENDDIBFORMAT", 4},
	"WING.#1003": {"WING", 1003, "WINGCREATEBITMAP", 10},
	"WING.#1004": {"WING", 1004, "WINGGETDIBPOINTER", 6},
	"WING.#1006": {"WING", 1006, "WINGSETDIBCOLORTABLE", 10},
	"WING.#1010": {"WING", 1010, "WINGBITBLT", 16},
	// --- TOOLHELP：PTO2 於 2026-09-11 補（2 支）---
	"TOOLHELP.#77": {"TOOLHELP", 77, "TERMINATEAPP", 4},
	"TOOLHELP.#80": {"TOOLHELP", 80, "TIMERCOUNT", 4},
}
